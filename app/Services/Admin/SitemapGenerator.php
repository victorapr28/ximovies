...
class SitemapGenerator {
    ...
    public function generate()
    {
        ...
        foreach ($this->config as $modelConfig) {
            list($builder, $table) = $this->getModel($modelConfig);
            $index[$table] = $this->createSitemapForResource($builder, $table);
        }
    ...
    {
        $model
            ->chunkById($this->queryLimit, function($records) use($name) {
